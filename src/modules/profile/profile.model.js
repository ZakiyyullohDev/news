...
const ProfileModel = {
    ...
    editProfile: async function (body, token, user_image) {
        ...
        await queryFunc(
            `UPDATE users SET user_first_name = $1, user_last_name = $2, user_email = $3, user_password = $4 WHERE user_id = $5`,
        ...
        const uploadPath = `${process.cwd()}/uploads/users/${decodedToken}.${imageExt}`
